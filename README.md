...
## The controller:
The Adafruit RP2040 feather ThinkInk dev board ([Adafruit part# 5727](https://www.adafruit.com/product/5727) is at the heart of the reader. It features the same RP2040 microcontroller as in Raspberry's own Pi Pico, a charging circuit for a LiPo battery, and an interface for a 24-pin e-paper display.
