...
**Different fonts.** For a relatively low resolution display like this you need to use bitmap fonts. And they need to cover the character set you wish to use, in this case the CP1252 8-bit set. I settled on a single sans-serif proportional font, in normal, bold, italic and bold-italic. It is limiting though, so in the future I might add a serifed monospace "typewriter" font.  
